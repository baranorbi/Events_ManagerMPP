...
class DatabaseService:
    ...
    def _seed_sample_data(self):
        # admin user - remove updated_at since it doesn't exist
        admin_user, created = User.objects.get_or_create(
            ...
            defaults={
                ...
                'password': 'admin123',
                'role': 'ADMIN',
                # Remove these lines - they don't exist in your User model:
                # 'created_at': timezone.now(),  # This is auto-generated by auto_now_add=True
                # 'updated_at': timezone.now(),  # This field doesn't exist
            }
        )
        
        # regular user - remove updated_at since it doesn't exist
        ...
        # Create sample events - remove created_at and updated_at since they don't exist
        events = [
            {
                'id': '1',
                ...
                'is_online': False,
                # Remove these lines - they don't exist in your Event model:
        ...
        # Create user-created events - remove created_at and updated_at
        user_events = [
            {
                'id': '101',
        ...
        for event_data in user_events:
            ...
            # Create UserEvent relationship if event was just created
            if created:
                UserEvent.objects.get_or_create(user_id='user1', event_id=event.id)
        
        # Add interested events for user
        interested_event_ids = ['2', '4', '6']
        for event_id in interested_event_ids:
            InterestedEvent.objects.get_or_create(user_id='user1', event_id=event_id)
