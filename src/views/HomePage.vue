<template>
  <AppLayout @search="handleSearch">
    ...
    <div v-if="filteredEvents.length > 0" class="container mx-auto px-4 py-8">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="event in paginatedEvents" :key="event.id" class="flex flex-col h-full">
          <EventCard :event="event" @view-details="openEventDetails">
            <template #actions>
              <button 
